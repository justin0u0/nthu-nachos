    ...
    case SyscallException:
      switch (type) {
        ...
        case SC_Open: {
          ...
          OpenFileId openFileId = SysOpen(fileName);
        ...
        case SC_Write: {
          ...
          int numberOfChar = SysWrite(buffer, size, openFileId);
          
          kernel->machine->WriteRegister(2, numberOfChar);
        ...
        case SC_Read: {
          ...
          int numberOfChar = SysRead(buffer, size, openFileId);
